...
var dot = {
	...
	draw: function(){
		...
		setEllipse(this.leftEye,this.x + this.LExOffset, this.y + this.LEyOffset,15,30,"black");
		setEllipse(this.rightEye,this.x + this.RExOffset, this.y + this.REyOffset,15,30,"black");
	}
